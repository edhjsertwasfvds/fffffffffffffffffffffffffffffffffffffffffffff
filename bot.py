...
CHECKER_ALLOWED_ROLES = set(_env_int_list("CHECKER_ALLOWED_ROLES", [1503512286223138900, 1503512343202758666, 1503512364404703392, ROLE_ADMIN_ID, ROLE_ADMIN_PLUS_ID, ROLE_STADMIN_ID, ROLE_GLADMIN_ID, ROLE_OWNER_ID, ROLE_OWNER_ALT_ID, ROLE_CURATOR_ID]))
